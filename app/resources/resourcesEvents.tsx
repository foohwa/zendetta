...
export const appointmentEvents: Appointment[] = [
  {
    ...
    start: "2024-07-13T00:00:00Z", // Adjusted to 8am UTC
    end: "2024-07-13T01:00:00Z", // Adjusted to 9am UTC
  ...
  },
  {
    ...
    appointmentDate: "2024-07-16",
    start: "2024-07-13T05:00:00Z", // Adjusted to 12pm UTC
    end: "2024-07-13T06:00:00Z", // Adjusted to 1pm UTC
    status: ReservationStatus.IN_PROGRESS,
    patientName: "Jane Smith",
    patientId: "pat002",
    treatment: {
  ...
  },
  {
    ...
    start: "2024-07-13T09:00:00Z", // Adjusted to 9am UTC
    end: "2024-07-13T10:00:00Z", // Adjusted to 10am UTC
  ...
  },
  {
    ...
    start: "2024-07-13T07:00:00Z", // Adjusted to 3pm UTC
    end: "2024-07-13T08:00:00Z", // Adjusted to 4pm UTC
  ...
  },
  {
    ...
    start: "2024-07-13T02:00:00Z", // Adjusted to 1pm UTC
    end: "2024-07-13T03:00:00Z", // Adjusted to 2pm UTC
    status: ReservationStatus.REGISTERED,
...
export const BlockedEvents = [
  {
    title: "Break Time",
    resourceId: ["84"],
    start: parseISO("2024-07-13T02:00:00Z"), // Adjusted to 1pm UTC
...
export const BackgroundEvents: Appointment[] = [
  {
    ...
    appointmentId: "apt002",
    appointmentDate: "2024-07-16",
    start: "2024-07-13T01:00:00Z", // Adjusted to 8am UTC
    end: "2024-07-13T03:00:00Z", // Adjusted to 9am UTC
    status: ReservationStatus.IN_PROGRESS,
    patientName: "Jane Smith",
    patientId: "pat002",
  },
